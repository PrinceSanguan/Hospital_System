...
export default function Notifications({ user, notifications }: NotificationsProps) {
    ...
    const markAllAsRead = () => {
        router.put(route('doctor.notifications.mark.all.read'));
    };
                                            ...
                                            <div className="flex items-center justify-between mt-4">
                                                {notification.related_id && notification.related_type === 'appointment' && (
                                                    <Button asChild size="sm" variant="outline">
                                                        <Link href={route('doctor.appointments.show', notification.related_id)}>
                                                            View Appointment
                                                        </Link>
                                                    </Button>
                                                )}
                                                ...
                                                {notification.related_id && notification.related_type === 'record' && (
                                                    <Button asChild size="sm" variant="outline">
                                                        <Link href={route('doctor.records.show', notification.related_id)}>
                                                            View Record
                                                        </Link>
                                                    </Button>
                                                )}

...
export default function MedicalRecords({ user, medicalRecords }: MedicalRecordsProps) {
  ...
  const filteredRecords = medicalRecords && medicalRecords.data ?
    medicalRecords.data : [];
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr>
                  <th className="py-3 px-4 text-left text-sm font-medium text-gray-500 border-b border-gray-200">Date</th>
                  <th className="py-3 px-4 text-left text-sm font-medium text-gray-500 border-b border-gray-200">Patient</th>
                  <th className="py-3 px-4 text-left text-sm font-medium text-gray-500 border-b border-gray-200">Record Type</th>
                  <th className="py-3 px-4 text-left text-sm font-medium text-gray-500 border-b border-gray-200">Details</th>
                  <th className="py-3 px-4 text-left text-sm font-medium text-gray-500 border-b border-gray-200">Status</th>
                  <th className="py-3 px-4 text-right text-sm font-medium text-gray-500 border-b border-gray-200">Actions</th>
                </tr>
              </thead>
              <tbody>

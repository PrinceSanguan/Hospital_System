...
export default function PatientDashboard({
    ...
    notifications = [
        ...
        },
        {
            ...
            message: 'Dr. Johnson has updated your prescription',
            read: false,
            created_at: '2023-05-01T08:30:00.000Z',
        },
    ...
    return (
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 overflow-auto">
                ...
                <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-white px-4 md:px-6">
                    ...
                    <div className="flex items-center gap-4 md:ml-auto">
                        ...
                        {showNotifications && (
                            <div className="absolute top-16 right-12 z-50 w-80 rounded-md border bg-white shadow-lg">
                ...
                <main className="p-4 md:p-6 lg:p-8">
                    ...
                    {/* Today's Overview */}
                    <div className="mb-8">
                        <h2 className="mb-4 text-xl font-semibold text-gray-800">Today's Overview</h2>
                                ...
                                {upcomingAppointments.length > 0 ? (
                                    <div className="space-y-4">
                                        {upcomingAppointments.slice(0, 3).map((appointment) => (
                                            <div
                                                key={appointment.id}
                                                className="flex flex-col rounded-lg border p-4 shadow-sm transition-shadow hover:shadow-md sm:flex-row sm:items-center"
                                            >
                                                <div className="mr-4 mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-blue-100 text-blue-600 sm:mb-0">
                                    ...
                                    {doctors.slice(0, 3).map((doctor) => (
                                        ...
                                        >
                                            <div className="flex items-center bg-blue-50 p-4">
                                                <div className="mr-3 h-16 w-16 overflow-hidden rounded-full border-2 border-blue-100 bg-white">
                                                    <img
                                                        src={
                                                            doctor.profile_image ||
                                                            `/images/doctor/${doctor.name.split(' ')[0]}.png` ||
                                                            doctor.image ||
                                            ...
                                            <div className="p-4">
                                                <div className="mb-3">
                                                    <div className="mb-1 flex items-center">
                                                        <img src="/images/logo_famcare.jpg" alt="Famcare Logo" className="mr-2 h-5 w-auto" />
                                                        ...
                                                        <div className="ml-6 text-sm text-gray-600">
                                                            {doctor.availability.map((day, idx) => (
                                                                <span key={`${doctor.id}-${idx}`} className="mr-2">
                                                                    {day}
                                                                    {idx < doctor.availability.length - 1 ? ',' : ''}
                                                                </span>
                                                            ))}
                                                        </div>
                                                    ) : (
                                                ...
                                                <details className="mb-3 border-t pt-2">
                                                    <summary className="cursor-pointer text-sm font-medium">Hours</summary>
            ...
            <Dialog open={isBookingDialogOpen} onOpenChange={setIsBookingDialogOpen}>
                <DialogContent className="max-h-[90vh] overflow-auto sm:max-w-[525px]">
                    <DialogHeader className="sticky top-0 z-10 border-b bg-white pb-2">
                    ...
                    {bookingDoctor && (
                        <div className="space-y-4 py-2">
                            ...
                            <div className="flex items-center space-x-3 rounded-md bg-gray-50 p-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-medium">{bookingDoctor.name}</h3>
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="rounded-md border p-2">
                                    <DayPicker
                                        ...
                                        disabled={[{ before: new Date() }, ...getDisabledDates(bookingDoctor.schedules || [])]}
                                        className="mx-auto"
                                        classNames={{
                    ...
                    <DialogFooter className="sticky bottom-0 mt-4 border-t bg-white pt-2">
                        ...
                        <Button
                            ...
                            disabled={
                                ...
                                !bookingTime ||
                                !bookingReason ||
                                (bookingDoctor?.services && bookingDoctor.services.length > 0 && !bookingService)
                            }
                        >
                            Request Appointment
                        </Button>

...
export default function MedicalRecords({ user, medicalRecords }: MedicalRecordsProps) {
    ...
    const filteredRecords = medicalRecords.data.filter((record) => record.status.toLowerCase() !== 'cancelled');
                ...
                <div className="flex-1">
                    ...
                    <main className="p-6">
                        <Card>
                            ...
                            <CardContent>
                                <Table>
                                    <caption className="text-muted-foreground mt-4 text-sm">A list of medical records</caption>
                                    <TableHeader>
                                        <TableRow>
                                                    ...
                                                    <TableRow key={record.id}>
                                                        ...
                                                        <TableCell>
                                                            ...
                                                            {isPendingAppointment && (
                                                                <span className="ml-2 block text-xs text-gray-500 italic">
